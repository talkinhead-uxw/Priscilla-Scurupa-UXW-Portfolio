...
const Projects = () => {
  const projects = [
    {
      id: 'fintech-app',
      title: 'App de Fintech - Onboarding',
      description: 'Redesign completo do fluxo de onboarding, resultando em 40% de aumento na conversão.',
      category: 'Mobile App',
      tags: ['UX Writing', 'Onboarding', 'Fintech'],
    ...
    },
    {
      ...
      description: 'Otimização do processo de checkout com foco na redução de abandono de carrinho.',
      category: 'E-commerce',
      tags: ['Microcopy', 'Conversão', 'E-commerce'],
      image: '/api/placeholder/400/300',
      metrics: {
        abandonment: '-30%',
        completion: '+35%',
    ...
    {
      id: 'saas-dashboard',
      title: 'SaaS Dashboard - Navegação',
      description: 'Criação de sistema de navegação intuitivo para plataforma B2B complexa.',
      category: 'SaaS',
      tags: ['Information Architecture', 'B2B', 'Dashboard'],
      image: '/api/placeholder/400/300',
      metrics: {
        usability: '+50%',
        support: '-25%',
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            ...
            para resolver problemas reais e gerar impacto mensurável.
          </p>
        </div>
